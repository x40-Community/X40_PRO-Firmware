...
Please note that with the latest firmware variants, the X-Offset is 5mm smaller than with the Weedo Stock firmware. This prevents the right extruder from colliding at X=0.
