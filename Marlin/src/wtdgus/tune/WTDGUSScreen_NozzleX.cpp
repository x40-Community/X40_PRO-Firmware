...
void DGUS_Screen_Nozzle_X::ShowPage(void)
{
    if (pageid == 0)  //X-Coarse tune 
    {
		...
		dserial.SendString(ADDR_NOFFSET_BUTTON3_TEXT, "3(347)", TEXTLEN_NOFFSET_ITEM);
		dserial.SendString(ADDR_NOFFSET_BUTTON4_TEXT, "4(348)", TEXTLEN_NOFFSET_ITEM);
		dserial.SendString(ADDR_NOFFSET_BUTTON5_TEXT, "5(349)", TEXTLEN_NOFFSET_ITEM);
